...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(template_name='users/login.html'), name='login'), #stis automates formes vazw .as_view() me to template_name='users/login.html' orizw pou 9a psa3ei auto to template
